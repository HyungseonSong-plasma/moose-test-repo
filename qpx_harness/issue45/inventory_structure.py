"""Compatibility adapters for Issue45 inventory structural policy.

The scientific nullspace and constrained-closure audits are recipe-owned.
Canonical MOOSE parameter helpers own parsing/mutation mechanics.  This module
preserves historical private imports until downstream consumers are migrated.
"""
...
def audit_constrained_quasisteady_structure(
    ...
    # Historical qpx_harness surface used the broader failure class. Preserve
    # it only at this compatibility boundary; recipe policy keeps the more
    # precise CLOSURE_STRUCTURE_FAIL class.
