"""Compatibility adapters for Issue45 constrained-closure runtime evidence."""
...
from .constants import LAMBDA_VARIABLE, RUNTIME_COLUMNS
...
def _evaluate_runtime_case_data(
    *,
    ...
    # Preserve the historical compatibility key while the recipe owns the
    # canonical, fully spelled metric name.
