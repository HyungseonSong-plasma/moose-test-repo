"""Reusable PETSc termination selection mechanics for canonical evidence."""
...
def first_failed_reason(rows: list[dict[str, Any]]) -> str | None:
    """Return the first explicitly non-converged reason from parsed rows."""
...
__all__ = ["first_failed_reason", "first_linear_termination"]
