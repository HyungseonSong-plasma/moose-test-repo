"""Domain-specific diagnosis presets built on the generic evaluator and Z3 engine."""
...
def build_constant_state_registry(
    ...
    """Build the canonical Green-Gauss constant-state metric/rule registry."""
...
def build_constant_state_ruleset(
    ...
    """Build the default externally replaceable Z3 logic set for Green-Gauss."""
