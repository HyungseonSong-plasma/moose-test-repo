...
This is the canonical error-evidence implementation. It preserves the original
QPX dual-ledger contract while making it part of the unified evidence engine.
"""
