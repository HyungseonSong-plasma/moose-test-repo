"""P0 characterization for the stable stats_builder composition facade."""

from __future__ import annotations


def self_test() -> int:
    """Characterize representative producer fact shapes through the public facade."""
    ...
    try:
        ...
        assert any(
            timing.source == "petsc_log" and timing.total_seconds == 0.4
            for timing in stats.efficiency.timings
        )
