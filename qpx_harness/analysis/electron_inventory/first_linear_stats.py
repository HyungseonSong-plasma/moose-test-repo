"""Stats mapping for the inventory first-linear diagnostic."""
...
def build_first_linear_stats(
    ...
    *,
    ...
    from qpx_harness.analysis.metrics.accuracy import build_jacobian_accuracy_stats
    from qpx_harness.analysis.stats_builder import (
