"""Canonical closed electron/bulk-Poisson feedback construction basis.

This adapter composes the accepted feedback construction from reusable MOOSE mechanics.
...
from . import feedback_relaxation as fast_relaxation
