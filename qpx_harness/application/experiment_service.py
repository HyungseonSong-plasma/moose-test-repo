...
def run_experiment(spec_or_path: ExperimentSpec | str | Path) -> int:
    spec = spec_or_path if isinstance(spec_or_path, ExperimentSpec) else load_experiment_spec(spec_or_path)
