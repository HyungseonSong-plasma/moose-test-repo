"""Green-Gauss constant-state validation policy over canonical reasoning APIs."""
...
class EvidenceTolerances(BaseModel):
    """Validated absolute tolerances for the Green-Gauss constant-state check."""
    ...
    return RuleSet(
        rules=(
            ...
            ReasoningRule(
                ...
                all_of=(
                    MetricPredicate(
                        "gradient_reconstruction_delta", "gt", tol.gradient_match_abs
                    ),
                ),
            ...
            ReasoningRule(
                ...
                priority=50,
                all_of=(MetricPredicate("runtime_gradient", "gt", tol.qpx_gradient_abs),),
                location_metric_id="runtime_gradient",
            ),
        ),
        pass_status="CONSTANT_STATE_PASS",
    )
...
def summarize_constant_state_report(
    ...
    *,
    ...
    return evaluate_diagnostic_rules(
        ...
        build_constant_state_ruleset(tolerances),
...
def summarize_constant_state(
    ...
    *,
    ...
    """Return the characterized historical dictionary shape without legacy imports."""
