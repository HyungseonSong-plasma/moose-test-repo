"""Semantic runtime owner for the Issue43 electron-Poisson coupling diagnostic.
...
owned by reusable primitives. This module owns the Issue43-specific structural
checks, failure classification, evidence, and P0/P1/P2/P3 orchestration.
"""
