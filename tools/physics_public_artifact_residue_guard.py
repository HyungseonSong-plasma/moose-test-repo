#!/usr/bin/env python3
"""Fail if active public-CI surfaces retain legacy package naming/contracts."""
...
def main() -> int:
    ...
    if findings:
        print("ACTIVE_LEGACY_ARTIFACT_RESIDUE=FAIL")
        print("\n".join(findings))
        return 1

    print("ACTIVE_LEGACY_ARTIFACT_RESIDUE=PASS")
    return 0
