...
Repository-specific developer/static validation belongs under `ci/guards/`. Reusable operational skills are centrally owned by `HyungseonSong-plasma/chatgpt-operation` and must not be vendored into this repository. Repository mutation is pinned at `0ed25494cead9dcfa6ec567790fbf7ca2c943c00`; governed-work execution is pinned at `0ed25494cead9dcfa6ec567790fbf7ca2c943c00`; controller lifecycle/throughput/state-refresh evaluation is pinned at `0ed25494cead9dcfa6ec567790fbf7ca2c943c00`. Do not recreate a local `skills/`, loose root-level tool surface, or general `scripts/` dumping ground.
...
chatgpt-operation@0ed25494cead9dcfa6ec567790fbf7ca2c943c00
