...
| Phase / pack | Owner | Trigger |
|---|---|---|
| PLAN | `docs/protocols/problem_solving.md` | scope/decomposition/diagnosis framing |
| RESEARCH | `docs/protocols/problem_solving.md` | source/model/provenance/representation uncertainty |
| IMPLEMENT | `docs/protocols/coding.md` | code/harness/script/checker changes |
| VALIDATE | `docs/protocols/validation.md` | executable/runtime/PASS-FAIL evidence |
| CLOSE | issue acceptance + `validation.md` / `milestone_delivery.md` as applicable | closure/integration decision |
| SCIENTIFIC_EXECUTION | `docs/protocols/scientific_execution.md` | cross-layer intent/regime preservation |
...
- `docs/knowledge/TROUBLESHOOTING_INDEX.md` — known reusable symptom/fix evidence
- `docs/incidents/` — historical incident evidence

Load only matching material.
