...
EXPECTED_SOURCE_RELATIVE = Path("src/materials/PhysicsThermalDiffusionMaterial.C")
EXPECTED_HEADER_RELATIVE = Path("include/materials/PhysicsThermalDiffusionMaterial.h")
...
def _check_frozen_contract() -> None:
    ...
    if EXPECTED_SOURCE_RELATIVE != Path("src/materials/PhysicsThermalDiffusionMaterial.C"):
        raise AssertionError("PF-3 source path contract drift")
    if EXPECTED_HEADER_RELATIVE != Path("include/materials/PhysicsThermalDiffusionMaterial.h"):
