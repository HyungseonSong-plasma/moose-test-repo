# Issue #253 G2: electron-particle / electron-energy / Poisson discriminator.
# Energy wall flux is always ON. Joule heating and O2 elastic energy exchange
# are independently toggled by the sequence-09 2x2 matrix.
# Chemistry and heavy-particle evolution remain frozen.
...
[MultiApps]
  [poisson]
    ...
    relaxation_factor = 0.09090909090909091
