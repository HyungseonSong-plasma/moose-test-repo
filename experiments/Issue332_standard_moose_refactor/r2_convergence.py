...
def _standardize_convergence(fast: str) -> str:
    ...
    # When a user-supplied non-default convergence is selected, pinned MOOSE
    # requires fixed-point default parameters to be owned by the explicit
    # DefaultMultiAppFixedPointConvergence object rather than the Executioner.
    for line in (
        "  fixed_point_min_its = 2\n",
        "  fixed_point_max_its = 3000\n",
        "  fixed_point_rel_tol = 1.0e-8\n",
