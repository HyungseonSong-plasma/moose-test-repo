...
def _volumetric_electron_kernel_paths(text: str) -> list[str]:
    ...
    for path in base._children(text, "FVKernels"):
        ...
        # terms.  Keep time/diffusion and all boundary energy owners.
