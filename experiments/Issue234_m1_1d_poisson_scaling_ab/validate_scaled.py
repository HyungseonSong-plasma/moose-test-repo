#!/usr/bin/env python3
"""Validate the scaled Issue #234 one-way Poisson observer against the accepted particle control."""
...
CANDIDATE_CSV = ROOT / "input_poisson_observer_scaled_out.csv"
INPUT = ROOT / "input_poisson_observer_scaled.i"
...
def main() -> int:
    ...
    static = {
        "automatic_scaling_on": "automatic_scaling = true" in text,
        "off_diagonal_scaling_on": "off_diagonals_in_auto_scaling = true" in text,
        "compute_scaling_once": "compute_scaling_once = true" in text,
    ...
    runtime = {
        ...
        "particle_inventory_decreases": 0.0 < pf["c_e_inventory_per_area"] < p0["c_e_inventory_per_area"],
    ...
    summary = {
        ...
        "claim_scope": (
            "automatic-scaling conditioning discriminator for the electron-only one-way "
            "Poisson observer; physics/coupling unchanged from failed run 35333687439"
        ),
        "prior_unscaled_evidence": {
            "head": "360fccd43ad6ca4d28ce42c536228fa714ecb131",
            "run": 35333687439,
            "classification": "P0/P1/P2 PASS; P3 no positive-time state; nonlinear failure down to dtmin",
        },
        ...
        "scientific_interpretation": (
            "PASS supports nonlinear scaling/conditioning as the discriminator owner; "
            "it does not by itself authorize closed electron-Poisson feedback or M1 acceptance."
        ),
