...
[FunctorMaterials]
  ...
  [mobility_Op]
    ...
    block = plasma
  []
  [r30_electron_constants]
    type = ADGenericFunctorMaterial
    prop_names = 'r30_mean_energy r30_carrier_one'
    prop_values = '5.73276 1.0'
    block = plasma
  []
    [r30_electron_transport_lookup]
      type = QPXElectronTransportLookupMaterial
      property_table_file = '/home/songhyeongseon/projects/qvt3d/qpx/examples/modular/chemistry/bolsig-/O2/table/electron_moments.txt'
      mean_energy = r30_mean_energy
      pressure = p
      gas_temperature = T_g
      bounds_policy = error
      block = plasma
  ...
  [r30_charge_density]
    ...
    block = plasma
  []
  [r30_poisson_relative_permittivity]
    type = ADGenericFunctorMaterial
    prop_names = 'r30_relative_permittivity'
    prop_values = '1'
    block = plasma
  []
  [r29_heavy_charge_number]
    type = ADParsedFunctorMaterial
    property_name = r29_heavy_charge_number
    functor_names = 'rho_mat w_O2p w_Om w_Op'
    functor_symbols = 'rhoheavy fracO2p fracOm fracOp'
    expression = '6.0220000000000003e+23*rhoheavy*(fracO2p/0.032-fracOm/0.016+fracOp/0.016)'
    block = plasma
  []
  [r29_electron_charge_number]
    type = ADParsedFunctorMaterial
    property_name = r29_electron_charge_number
    functor_names = 'n_e_solved'
    functor_symbols = 'nelec'
    expression = '-nelec'
    block = plasma
  []
  [r29_sum_w]
    type = ADParsedFunctorMaterial
    property_name = r29_sum_w
    functor_names = 'w_O2_constraint w_O2s w_O2p w_O w_Om w_Op w_Os'
    functor_symbols = 'fracO2 fracO2s fracO2p fracO fracOm fracOp fracOs'
    expression = 'fracO2+fracO2s+fracO2p+fracO+fracOm+fracOp+fracOs'
    block = plasma
  []
[]
...
[Postprocessors]
  ...
  [r29_heavy_charge_number_integral]
    type = ElementIntegralFunctorPostprocessor
    functor = r29_heavy_charge_number
    block = plasma
    execute_on = 'TIMESTEP_END'
  []
  [r29_electron_charge_number_integral]
    type = ElementIntegralFunctorPostprocessor
    functor = r29_electron_charge_number
    block = plasma
    execute_on = 'TIMESTEP_END'
  []
  [r29_sum_w_min]
