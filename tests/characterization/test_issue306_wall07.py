...
from experiments.Issue306_heavy_charge_motion import wall07_control


def test_issue306_wall07_thermal_heavy_dt_ratio_contract(tmp_path, monkeypatch):
    generated = tmp_path / "generated_wall07"
    monkeypatch.setattr(wall07_control, "GENERATED", generated)
    try:
        summary = wall07_control.static_contract()
        ...
        for ratio, cycles in ((2, 300), (4, 150), (8, 75)):
            case = generated / f"thermal_ratio{ratio}"
